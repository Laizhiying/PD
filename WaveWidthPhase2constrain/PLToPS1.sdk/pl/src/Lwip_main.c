...
int main()
{
	...
	num = 0;
    stop_flag = 0;
	MonopulseExThreshould = 180;
	MonopulseExHold = 6;
	MonopulseMultiThreshould = 10;
	GentalThreshould = 135;
...
//
	    xemacif_input(netif);//将MAC队列里的packets传输到你的LwIP/IP stack里
        ReadFlag = Xil_In32(XPAR_EMC_0_S_AXI_MEM0_BASEADDR+52);
        ARM_read = 1;
        ProcessOver = Xil_In32(XPAR_EMC_0_S_AXI_MEM0_BASEADDR+56);
