...
#
# Generated by Vivado on Tue Dec 17 20:03:30 +0800 2019
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"$ref_dir/../../../ipstatic" +incdir+"D:/Software/Xilinx17.4/Vivado/2017.4/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" +incdir+"D:/Software/Xilinx17.4/Vivado/2017.4/data/xilinx_vip/include" \
    "$ref_dir/../../../../PLToPS1.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_clk_wiz.v" \
    "$ref_dir/../../../../PLToPS1.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0.v" \
  2>&1 | tee -a vlogan.log
