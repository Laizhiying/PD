...
module system
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.FCLK_CLK0_0 CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.FCLK_CLK0_0, CLK_DOMAIN system_processing_system7_0_0_FCLK_CLK0, FREQ_HZ 100000000, PHASE 0.000" *) output FCLK_CLK0_0;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:interrupt:1.0 INTR.SENDIRQ INTERRUPT" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME INTR.SENDIRQ, PortWidth 1, SENSITIVITY LEVEL_HIGH" *) input [0:0]SendIRQ;
  output [31:0]mem_a_0;
  output [0:0]mem_cen_0;
  input [31:0]mem_dq_i_0;
  output [31:0]mem_dq_o_0;
  output [0:0]mem_oen_0;
  output mem_wen_0;

  wire [0:0]IRQ_F2P_0_1;
  ...
  assign IRQ_F2P_0_1 = SendIRQ[0];
  assign mem_a_0[31:0] = axi_emc_0_mem_a;
  assign mem_cen_0[0] = axi_emc_0_mem_cen;
  assign mem_dq_i_0_1 = mem_dq_i_0[31:0];
  assign mem_dq_o_0[31:0] = axi_emc_0_mem_dq_o;
  assign mem_oen_0[0] = axi_emc_0_mem_oen;
  assign mem_wen_0 = axi_emc_0_mem_wen;
